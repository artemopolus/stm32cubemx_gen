...
#include "i2c4_generated.h"
EMBOX_UNIT_INIT(I2C4_FULL_DMA_init);
static int I2C4_FULL_DMA_init(void)
{
  ...
  */
  ...
  /* I2C4_RX Init */
  LL_DMA_SetChannelSelection(DMA1, LL_DMA_STREAM_2, LL_DMA_CHANNEL_2);
  ...
  /* I2C4_TX Init */
  LL_DMA_SetChannelSelection(DMA1, LL_DMA_STREAM_5, LL_DMA_CHANNEL_2);
...
STATIC_IRQ_ATTACH(16, I2C4_FULL_DMA_tx_irq_handler, NULL);
STATIC_IRQ_ATTACH(13, I2C4_FULL_DMA_rx_irq_handler, NULL);
