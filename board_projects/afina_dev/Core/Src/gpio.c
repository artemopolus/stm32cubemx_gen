...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(DCMI_RWDN_GPIO_Port, DCMI_RWDN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(DCMI_RST_GPIO_Port, DCMI_RST_Pin);

  /**/
  LL_GPIO_ResetOutputPin(SDIO_DET_GPIO_Port, SDIO_DET_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(DCMI_RWDN_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(DCMI_RST_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(SDIO_DET_GPIO_Port, &GPIO_InitStruct);
